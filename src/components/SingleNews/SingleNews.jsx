...
<div className="row mt-2 d-flex justify-content-around">
    ...
    <div><p className=' me-3 text-end py-2  '> {readingTime}minutes</p></div>

        <div style={{cursor:"pointer"}} onClick={()=>handleBookMark(title)} > <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-25"> 
...
<p><a onClick={()=>handleSpendTime(readingTime)}   className="link-opacity-100 ms-3" href="#ok">mark as read</a></p>
</div>
